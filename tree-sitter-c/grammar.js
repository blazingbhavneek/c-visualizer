...
module.exports = grammar({
  ...
  conflicts: $ => [
    ...
    [$._declarator, $.expression, $.type_specifier, $.macro_type_specifier],
    [$._declarator, $.type_specifier, $.expression],
  ],
  ...
  rules: {
    ...
    function_definition: $ => choice(
      ...
      // K&R implicit-int: NO return type
      prec.dynamic(-1, seq(
        optional($.ms_call_modifier),
    ...
    _old_style_function_definition: $ => choice(
      seq(
        optional($.ms_call_modifier),
        $._declaration_specifiers,
